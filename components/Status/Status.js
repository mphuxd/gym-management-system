...
function Status({ status }) {
  ...
  switch (status) {
    ...
    case "INACTIVE":
      ...
      break;
    case "LATE":
      icon = <CheckmarkOutlineWarning className={cx(className, "fill-yellow8")} />;
      break;
    case "CANCELLED":
      icon = <CheckmarkOutlineError className={cx(className, "fill-green10")} />;
      break;
    case "BANNED":
